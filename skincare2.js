...
function addItemToCart() // Adds a selected item with quantity and option to the cart
{
	...
	switch (itemValue) // Assign price and name based on selected item
	{
		case "lotion":
			price = 14.99;
			displayName = "CeraVe Moisturizing Lotion";
			break;
		case "sunscreen":
			price = 16.99;
			displayName = "Neutrogena Sunscreen Spray";
			break;
		case "cleanser":
			price = 9.99;
			displayName = "Garnier Facial Cleansing Water";
			break;
		case "serum":
			price = 12.99;
			displayName = "The Ordinary Vitamin C Serum";
			break;
		default:
	...
	switch (optionValue) // Apply discount or gift wrap if selected
	{
		...
		case "giftwrap":
			...
			break;
		case "none": // no change for if user selects none
	}
